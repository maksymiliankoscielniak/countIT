        ...
        <div className="topbarMeta">
          ...
          {currentUser ? (
            <div className="userChip">
              ...
              <button className="userChipLogout" type="button" onClick={() => setIsSettingsOpen(true)} title="Settings" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              ...
              <button className="userChipLogout" type="button" onClick={logout} title="Logout" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
